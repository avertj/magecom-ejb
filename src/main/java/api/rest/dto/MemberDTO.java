...
import api.rest.dto.NestedComboDTO;
...
public class MemberDTO implements Serializable
{
   ...
   public Member fromDTO(Member entity, EntityManager em)
   {
      ...
      while (iterDecks.hasNext())
      {
         ...
         Iterator<NestedDeckDTO> iterDtoDecks = this.getDecks().iterator();
         while (iterDtoDecks.hasNext())
         {
            NestedDeckDTO dtoDeck = iterDtoDecks.next();
      ...
      while (iterCombos.hasNext())
      {
         ...
         Iterator<NestedComboDTO> iterDtoCombos = this.getCombos()
               .iterator();
         while (iterDtoCombos.hasNext())
         {
            NestedComboDTO dtoCombo = iterDtoCombos.next();
      ...
      Iterator<NestedComboDTO> iterDtoCombos = this.getCombos().iterator();
      while (iterDtoCombos.hasNext())
      {
         boolean found = false;
         NestedComboDTO dtoCombo = iterDtoCombos.next();
   ...
   public void setDecks(final Set<NestedDeckDTO> decks)
   {
      this.decks = decks;
   }

   public Set<NestedComboDTO> getCombos()
   {
      return this.combos;
   }

   public void setCombos(final Set<NestedComboDTO> combos)
   {
      this.combos = combos;
   }

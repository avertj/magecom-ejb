...
public class ComboEndpoint
{
   ...
   public Response create(ComboDTO dto)
   {
      ...
      em.persist(entity);
      return Response.created(UriBuilder.fromResource(ComboEndpoint.class).path(String.valueOf(entity.getId())).build()).build();
   }
   ...
   public Response findById(@PathParam("id") Long id)
   {
      ...
      ComboDTO dto = new ComboDTO(entity);
   ...
   public List<ComboDTO> listAll(@QueryParam("start") Integer startPosition, @QueryParam("max") Integer maxResult)
   {
      ...
      {
         ComboDTO dto = new ComboDTO(searchResult);
         results.add(dto);
      }
      return results;
   }
